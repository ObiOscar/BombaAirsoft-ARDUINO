...
//Comienza el juego
//Este es el código importante, es un poco desordenado, pero funciona bien.
  while(1){    

//Código para parpadeo led
...
//Si la contraseña se introduce
    if('d' == keypad.getKey() && passwordEnable){
      ...
      delay(1000);        //Tiempo para que el jugador piense la contraseña
      lcd.clear();
      lcd.setCursor(0, 0);
      lcd.print(ENTER_CODE);

      setCode();        //Necesitamos establecer primero la variable de comparación
